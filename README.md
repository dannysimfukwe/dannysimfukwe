...
- [stable-cli-rails](https://www.stable-rails.com) – An Open-Source CLI tool to manage local Rails applications with automatic Caddy setup on macOS, local trusted HTTPS certificates, and easy start/stop functionality.
